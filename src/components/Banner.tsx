const Banner = () => {
  return (
    <div className="flex flex-col justify-center items-center h-[450px] w-[calc(-240px+100vw)] mt-[87px] bg-no-repeat bg-cover bg-center bg-opacity-50 bg-black bg-[url('../assets/images/banner.jpg')]">
